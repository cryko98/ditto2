...
import { Github, Menu, X, Info, ArrowUpRight } from 'lucide-react';
      ...
      >
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-400">
            <button onClick={() => scrollToSection('features')} className="hover:text-white transition-colors duration-200 hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]">Features</button>
            <button onClick={() => scrollToSection('how-it-works')} className="hover:text-white transition-colors duration-200 hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]">How it works</button>
            <button onClick={() => scrollToSection('about')} className="hover:text-white transition-colors duration-200 hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]">About</button>
            <button 
          ...
          {/* Mobile Toggle */}
          <button 
            className="md:hidden p-2 text-slate-400 hover:text-white transition-colors hover:bg-white/5 rounded-lg"
